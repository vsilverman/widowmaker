...
public class InferenceQueryValidator
  ...
  public InferenceQueryValidator() {
    prefixes = new HashMap<String, String>();
  }

  public InferenceQueryValidator(HashMap cannedPrefixes) {
    prefixes = (HashMap)cannedPrefixes.clone();
    
  }

  public InferenceQueryValidator(HashMap cannedPrefixes, String xml) {
    prefixes = (HashMap)cannedPrefixes.clone();
    
  }

  public InferenceQueryValidator(ValidationManager manager) {
    prefixes = new HashMap<String, String>();
  }
  ...
  public InferenceQueryValidator( int queryId,
              String response) {
    prefixes = new HashMap<String, String>();
    this.queryId = queryId;
    loadResponse(response);
  ...
  public void loadResponse(String rdf) {
    ...
    // so, can we just hang onto the empty-ish model even when a parse
    // exception occurs?
    responseModel = m;
    ...
    try {
      ...
      // we want to log what just happened, and then re-throw so the caller knows
      System.out.println("turtle response being parsed:");
      System.out.println(rdf);
      // what if we just use the empty response model???????
      // throw e;
    }
  }
  ...
  public boolean doValidation() {
    ...
    boolean bval = compareModels(resultsList, responseList);
    return bval;
  ...
  public static void main(String[] args) {
    ...
    InferenceQueryValidator data = new InferenceQueryValidator();
