...
/************************************************************************************************
 * LoadTestData class holds all information about what actions are to be performed by XccStressTester
 *
 *************************************************************************************************/
package test.stress;
...
//ask chengfei and John if these are necessary I did not see them being used
   ...
   *          String
   */
  public LoadTestData(String fileName) throws Exception {
    super(fileName);
	...
	//ask chengfei and John if these are necessary I did not see them being used last and first names
  ...
  public void setAll(Node operationsNode) {
    ...
    tmp = getNodeText(((Element) operationsNode).getElementsByTagName(
        "load-limit").item(0));
    if (!(tmp == null || tmp.equals("")))
      loadLimit = Integer.parseInt(tmp);
    ...
    System.out.println("setAll:  loadDir is " + loadDir);
