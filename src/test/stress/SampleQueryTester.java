...
public class SampleQueryTester extends QueryTester {
  
  SampleLoadTester loadTester = null;

  public SampleQueryTester(ConnectionData connData, 
                           SampleQueryTestData queryData, String threadName) {
    super(connData, queryData, threadName);
    loadTester = new SampleLoadTester(connData, queryData.loadData,
                                      threadName, this);
  }
