...
/**
 * This is an example module that seems to have a date format internal to DB that
 * shows up in their data. It demonstrates what it's like to have a one-off class
 * to produce some custom variable data for a template.
 */
public class CustomDateTimeWithOffsets
   ...
   * class loader
   */
  public CustomDateTimeWithOffsets() {
    super();
    formatString = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSS";
  }
  ...
  public String generateData(String token) {
    ...
    str = str + "+";
    str = str + Integer.toString(parseFieldManager.getRandomNumberGenerator().nextInt(6));
    str = str + Integer.toString(parseFieldManager.getRandomNumberGenerator().nextInt(6));
    str = str + ":";
    str = str + Integer.toString(parseFieldManager.getRandomNumberGenerator().nextInt(6));
    str = str + Integer.toString(parseFieldManager.getRandomNumberGenerator().nextInt(6));
