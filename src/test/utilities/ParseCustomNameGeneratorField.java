...
public class ParseCustomNameGeneratorField
   ...
   * class loader
   */
  public ParseCustomNameGeneratorField() {
  ...
  public static final String CUSTOM_NAME_FIELD = "customName";

  public String generateData(String token, HashMap contextData) {

    String gen;
    String name = (String)contextData.get(CUSTOM_NAME_FIELD);
    if (name == null) {
      gen = generateData(token);
      contextData.put(CUSTOM_NAME_FIELD, gen);
    } else {
      gen = name;
    }
